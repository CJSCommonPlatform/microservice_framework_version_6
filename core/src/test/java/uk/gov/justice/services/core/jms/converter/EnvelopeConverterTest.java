...
public class EnvelopeConverterTest {
    ...
    public void shouldReturnEnvelope() throws Exception {
        ...
        when(jsonObjectConverter.asEnvelope(messageAsJsonObject)).thenReturn(envelope);
    ...
    public void shouldReturnMessage() throws Exception {
        when(jsonObjectConverter.fromEnvelope(envelope)).thenReturn(messageAsJsonObject);
