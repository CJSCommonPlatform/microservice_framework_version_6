...
class  JaxRsImplementationGenerator {
    ...
    private static final String REST_PROCESSOR_MULTIPART_METHOD_STATEMENT = "return restProcessor.process($L, $L::process, $L.actionOf($S, $S, headers), headers, $L.parameters(), $L.createFileInputDetailsFrom($L, $L))";
