...
/**
 * Wrapper for JMS senders for to accommodate the new JMS client generator and provide backwards
 * compatibility. If the primary sender throws and exception due to a missing handler then it should
 * fail back to the secondary handler
 */
public class JmsSenderWrapper implements Sender {

    private final Sender primarySender;
    private final Optional<Sender> legacySender;
     ...
     */
    public JmsSenderWrapper(final Sender primarySender, final Optional<Sender> legacySender) {
