...
public class HandlerMethod {
    ...
    /**
     * Invokes the handler method passing the <code>jsonEnvelope</code> to it.
     *
     * @param jsonEnvelope the jsonEnvelope that is passed to the handler method
     * @return the result of invoking the handler, which will either be an {@link JsonEnvelope} or a
     * null {@link Void}
     */
    @SuppressWarnings("unchecked")
    public Object execute(final JsonEnvelope jsonEnvelope) {
        try {
