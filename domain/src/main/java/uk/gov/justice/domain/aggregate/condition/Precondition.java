...
public class Precondition {
    ...
    /**
     * Check if the precondition is met (ie, the assertion returns true) and if it is not then
     * throw a runtime exception with the given message.
    ...
    /**
     * Check if the precondition is met (ie, the assertion returns true) and if it is not then
     * throw an exception created by a supplier.
