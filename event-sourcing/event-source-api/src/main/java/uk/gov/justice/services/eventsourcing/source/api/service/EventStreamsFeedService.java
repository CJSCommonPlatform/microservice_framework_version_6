...
import uk.gov.justice.services.eventsourcing.source.api.feed.eventstream.EventStreamEntryFeedMaxMinProvider;
...
public class EventStreamsFeedService implements FeedService<EventStreamEntry> {
    ...
    public void initialise() {
        feedGenerator = new FeedGenerator<>(repository, new EventStream2FeedEntryMappingStrategy(), new EventStreamEntryFeedMaxMinProvider());
    }
