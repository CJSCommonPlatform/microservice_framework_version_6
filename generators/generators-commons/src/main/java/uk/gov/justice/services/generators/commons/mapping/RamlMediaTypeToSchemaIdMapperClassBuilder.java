...
public class RamlMediaTypeToSchemaIdMapperClassBuilder {
    ...
    public RamlMediaTypeToSchemaIdMapperClassBuilder(final RamlSchemaMappingClassNameGenerator schemaMappingClassNameGenerator) {
