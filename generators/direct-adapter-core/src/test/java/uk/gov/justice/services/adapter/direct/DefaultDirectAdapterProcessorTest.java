...
public class DefaultDirectAdapterProcessorTest {
    ...
    private DirectAdapterProcessor directAdapterProcessor;

    @Test
    public void shouldApplyInterceptorChainFunctionToTheIncomingTheEnvelope() throws Exception {
        directAdapterProcessor = new DefaultDirectAdapterProcessor(new String[] {"action1"});
    ...
    public void shouldReturnEnvelopeReturnedByInterceptorChainFunction() throws Exception {
        directAdapterProcessor = new DefaultDirectAdapterProcessor(new String[] {"action2"});
    ...
    public void shouldThrowExceptionIfActionNotSupported() throws Exception {
        ...
        directAdapterProcessor.process(envelope().with(metadataWithRandomUUID("action3")).build(), interceptorChainFunction);
