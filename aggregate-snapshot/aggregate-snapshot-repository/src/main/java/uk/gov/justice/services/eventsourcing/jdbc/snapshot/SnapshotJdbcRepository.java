...
public class SnapshotJdbcRepository implements SnapshotRepository {
    ...
    @Inject
    EventSourceDefinitionRegistry eventSourceProducerRegistry;
    ...
    private void initialiseDataSource() {
        final String jndiName = eventSourceProducerRegistry.getDefaultEventSourceDefinition().getLocation().getDataSource().get();
