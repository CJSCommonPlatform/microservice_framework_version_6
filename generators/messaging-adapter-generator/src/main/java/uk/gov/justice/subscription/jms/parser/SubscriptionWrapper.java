...
public class SubscriptionWrapper {
    ...
    public SubscriptionWrapper(final SubscriptionDescriptor subscriptionDescriptor, final List<EventSourceDefinition> eventSources) {
        this.subscriptionDescriptor = subscriptionDescriptor;
        eventSourceMap = eventSources.stream().collect(toMap(EventSourceDefinition::getName, eventSource -> eventSource));
    }
