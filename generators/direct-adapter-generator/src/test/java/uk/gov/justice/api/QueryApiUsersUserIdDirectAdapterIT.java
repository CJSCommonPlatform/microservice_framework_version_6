...
public class QueryApiUsersUserIdDirectAdapterIT {


    private static final String GET_USER_ACTION = "people.get-user";

    @Inject
    QueryApiUsersUserIdDirectAdapter queryApiUsersUserIdDirectAdapter;
    ...
    @Classes(cdi = true, value = {
            ...
            QueryApiUsersUserIdDirectAdapter.class,
    ...
    public void shouldProcessEnvelopePassedToAdapter() throws Exception {
        ...
        queryApiUsersUserIdDirectAdapter.process(envelopePassedToAdapter);
    ...
    public void shouldReturnEnvelopeReturnedByHandler() {
        ...
        assertThat(queryApiUsersUserIdDirectAdapter.process(envelope().with(metadataWithRandomUUID(GET_USER_ACTION)).build()),
                is(responseEnvelope));
